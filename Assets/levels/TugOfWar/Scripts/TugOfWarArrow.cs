...
{
    public class TugOfWarArrow : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                SoundManager.Instance.PLaySoundTugClick();
        ...
        public void check_between_arrows()
        {
            ...
            if (my_pos.x >= (target_vr.x - dist_between_arrows) && my_pos.x <= (target_vr.x + dist_between_arrows))
            {
                ...
                TugOfWarController.Instance.canPull = true;
            }
            else
            {
                ...
                TugOfWarController.Instance.canPull = false;
            }
        }
